...
komma till nytta för oss på Precisiosn medicinskt laboratoriume
...
Precisionsmedicinsk laboratorium (PL) utför laboratoire tjänster och
analys för de tre verskamhetsområdena Klinisk patologi, Klinisk genetik
och Klinisk mikrobiologi.

För Pat och klin\_gen så handlar det om att PL blir tillsänt prov och
medföljande remiss och i bästa fall sänder tillbaka bakomliggande
genetiska varianter.

För Mikro så handlar det om att man får bakterieprov och sänder tillbaka
information om potentiella resistensgener och MLST varainter.
...
\chapter{Vad är National Genomics
Platform}\label{vad-uxe4r-national-genomics-platform}

\bookmarksetup{startatroot}

\chapter{Bioinformatiskt arbetsflöde - PL sällsynta diagnoser
1}\label{bioinformatiskt-arbetsfluxf6de---pl-suxe4llsynta-diagnoser-1}
